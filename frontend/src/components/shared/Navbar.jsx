        ...
        <div className="flex items-center gap-12">
            ...
            {user && user.role === 'recruiter' ? (
              <>
                <li className="relative pb-2 group">
                  <Link to="/admin/companies" className="hover:text-[#F83002] transition duration-200">
                    Companies
                  </Link>
          ...
          {!user ? (
            <div className="flex items-center gap-2">
              <Link to="/login">
                <Button variant="outline" className="border-white text-white hover:bg-gray-200 hover:text-black">
                  Login
                </Button>
              </Link>
              <Link to="/signup">
                  ...
                  <div className="flex flex-col text-gray-600">
                    {user && user.role === 'student' && (
                      <div className="flex items-center gap-2 cursor-pointer hover:text-[#6A38C2] transition duration-200">
                        <User2 />
                        <Button variant="link" className="text-gray-600 hover:text-[#6A38C2]">
                    ...
                    <div className="flex items-center gap-2 cursor-pointer  transition duration-200">
                      <LogOut />
                      <Button onClick={logoutHandler} variant="link" className="text-gray-600 ">
                        Logout
                      </Button>
                    </div>
                  </div>
